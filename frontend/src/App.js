...
const API_BASE_URL = "https://cybershield-xdr.onrender.com";
...
function App() {
  ...
  return (
    <div className="app">
      ...
      {/* PROJECT TITLE */}
      <h1>CyberShield XDR</h1>
      <p className="main-tagline">AI Threat Intelligence Platform</p>
      ...
      {/* SUBTITLE */}
      <p className="subtitle">AI-Powered Digital Threat Intelligence Platform</p>
      ...
      {result && (
        <div className="result-box">
          ...
          <h3>Threat Score: {result.score}</h3>
      ...
      {qrResult && (
        <div className="result-box">
          ...
          <h3>Risk Score: {qrResult.score}</h3>

          {/* RISK METER */}
          <div className="risk-meter">
            <div
              className="risk-fill"
              style={{ width: `${qrResult.score}%` }}
            ></div>
          </div>

          <p>QR Data: {qrResult.qr_data}</p>
      ...
      <div className="scanner-box">
        ...
        />
        <br />
        <button onClick={scanMessage}>Analyze Message</button>
      </div>
      ...
      {messageResult && (
        <div className="result-box">
          ...
          <h3>Risk Score: {messageResult.score}</h3>
      ...
      <footer className="footer">
        <p>Developed by Ajay Kumar</p>
        <p>B.Tech Cyber Security Project</p>
        <p>CyberShield XDR © 2026</p>
      </footer>
